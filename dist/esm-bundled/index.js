...
// node_modules/.pnpm/svg-path-parser@1.1.0/node_modules/svg-path-parser/parser.js
var require_parser = __commonJS({
  "node_modules/.pnpm/svg-path-parser@1.1.0/node_modules/svg-path-parser/parser.js"(exports, module) {
    "use strict";
...
// node_modules/.pnpm/svg-path-parser@1.1.0/node_modules/svg-path-parser/index.js
var require_svg_path_parser = __commonJS({
  "node_modules/.pnpm/svg-path-parser@1.1.0/node_modules/svg-path-parser/index.js"(exports, module) {
...
// src/cubic.ts
function sampleCubicBezier(x0, y0, x1, y1, x2, y2, x3, y3, tolerance2, addPoint) {
  if (x0 === x1 && x0 === x2 && x0 === x3 && y0 === y1 && y0 === y2 && y0 === y3) {
    return;
  }
  const x01 = (x0 + x1) / 2, y01 = (y0 + y1) / 2, x12 = (x1 + x2) / 2, y12 = (y1 + y2) / 2, x23 = (x2 + x3) / 2, y23 = (y2 + y3) / 2, x012 = (x01 + x12) / 2, y012 = (y01 + y12) / 2, x123 = (x12 + x23) / 2, y123 = (y12 + y23) / 2, x0123 = (x012 + x123) / 2, y0123 = (y012 + y123) / 2;
...
function svgPathToPolygons(svgPathString, opts = {}) {
  ...
  function addPoint(x, y) {
    if (opts.decimals && (opts == null ? void 0 : opts.decimals) >= 0) {
